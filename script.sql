...
insert into role(role_title, role_description)
values ('Admin', 'who can create accounts')
insert into role(role_title, role_description)
values ('Employee', 'Employee')
insert into role(role_title, role_description)
values ('Manager', 'who manages over their Employee')

insert into department(dep_title, chief_id)
values ('dep A', 1)
insert into department(dep_title, chief_id)
values ('dep B', 2)
...
values (1, 1, 'leemongyan', '12345')
insert into account(employee_id, role_id, username, pass)
values (2, 2, 'dingluuphat', '12345')
insert into account(employee_id, role_id, username, pass)
values (3, 3, 'nguyennhatnam', '12345')
...
values ('Annual leave')
insert into leave_type(leave_type)
values ('Public holiday')
insert into leave_type(leave_type)
values ('Religious holidays')
insert into leave_type(leave_type)
values ('Maternity leave')
insert into leave_type(leave_type)
values ('Paternity leave')
insert into leave_type(leave_type)
values ('Bereavement leave')
insert into leave_type(leave_type)
values ('Compensatory leave')
insert into leave_type(leave_type)
values ('Sabbatical leave')
insert into leave_type(leave_type)
values ('Unpaid Leave')

insert into request(employee_id, leave_id, date_start, date_end, request_status, request_to, request_description,
                    amount)
