...
public class GuiRequestChecking extends JFrame {
    ...
    private void BtnAcceptActionPerformed(ActionEvent e) {
        ...
        var employee = employeeDao.getEmployeeByEmployeeId( Integer.parseInt( table.getModel().getValueAt( table.getSelectedRow(), 2 ).toString() ) );
        ...
        var requestLeave = requestLeaveDao.getRequestLeaveByRequestID( Integer.parseInt( table.getModel().getValueAt( table.getSelectedRow(), 0 ).toString() ) );
